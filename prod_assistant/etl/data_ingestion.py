...
class DataIngestion:
    ...
    def _load_env_variables(self):
        ...
        required_keys = ["GOOGLE_API_KEYS", "ASTRA_DB_API_ENDPOINT", "ASTRA_DB_APPLICATION_TOKEN", "ASTRA_DB_KEYSPACE"]
    ...
    def transform_data(self):
        ...
        for _, row in self.product_data.iterows():
            product_entry = {
    ...
    def store_in_vector_db(self, documents:List[Documents]):
        """
